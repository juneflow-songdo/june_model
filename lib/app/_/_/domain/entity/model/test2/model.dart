...
import '../test3/model.dart';
import '../test4/_new/enum.dart';
import 'config.dart';

class Test2Model {
  Test2Model() {
    DocId = Test2ModelConfig.generateDocId();
  }
  ...
  static Test2Model fromUrlString(String urlString) {
    return _fromQueryParams(Uri.parse(urlString).queryParameters);
  }

  static Test2Model fromBase64QueryString(String queryUrlString) {
    return _fromQueryParams(Uri.splitQueryString(utf8.decode(base64.decode(queryUrlString))));
  }

  static Test2Model _fromQueryParams(Map<String, String> queryParams) {
    var obj = Test2Model();
    ...
    obj.C000 = Test3Model.fromBase64QueryString(queryParams['C000'] ?? Test3Model().toBase64QueryString());
    ...
    obj.J000 = List<String>.from(json.decode(queryParams['J000'] ?? "[]") ?? []).map((item) => Test3Model.fromBase64QueryString(item)).toList();
