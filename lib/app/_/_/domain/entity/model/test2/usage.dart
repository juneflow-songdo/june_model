...
T _button00 = T("00", onTap: (BuildContext context) async {
  ...
  Test3Model subObj = Test3Model();
  Test5Model subObj2 = Test5Model();
  subObj.I000 = 1004;
  subObj.S000 = '''dqwgqw 'dwq dqfgq dwq"d qwfqw,fqegwaf\qffqwafvffffffesf/qwfgwfdq''';
  subObj.T000 = DateTime.now();
  subObj.B000 = true;
  subObj.L000 = [
    '''dqwgqw 'dwq dqfgq dwq"d qwfqw,fqegwaf\qffqwafvffffffesf/qwfgwfdq''',
    '''dqwgqw 'dwq dqfgq dwq"d qwfqw,fqegwaf\qffqwafvffffffesf/qwfgwfdq''',
    '''dqwgqw 'dwq dqfgq dwq"d qwfqw,fqegwaf\qffqwafvffffffesf/qwfgwfdq''',
  ];
  subObj.C000 = subObj2;
  subObj.J000 = [
    subObj2,subObj2,subObj2,subObj2
  ];
  subObj.E000 = Test4Enum.P000;

  Test2Model obj = Test2Model();
  obj.I000 = 1004;
  obj.S000 = '''dqwgqw 'dwq dqfgq dwq"d qwfqw,fqegwaf\qffqwafvffffffesf/qwfgwfdq''';
  obj.T000 = DateTime.now();
  obj.B000 = true;
  obj.L000 = [
  '''dqwgqw 'dwq dqfgq dwq"d qwfqw,fqegwaf\qffqwafvffffffesf/qwfgwfdq''',
  '''dqwgqw 'dwq dqfgq dwq"d qwfqw,fqegwaf\qffqwafvffffffesf/qwfgwfdq''',
  ...
  obj.E000 = Test4Enum.P000;
  obj.R000 = 125.125;

  var url = obj.toUrlString();
  print(url);

  var query = obj.toBase64QueryString();
  print(query);

  var queryResult = Test2Model.fromBase64QueryString(query);
  print(queryResult.toString());

  var urlResult = Test2Model.fromUrlString(url);
  print(urlResult.toString());

  print(obj.toString());

  print(obj.C000.toString());
  print(obj.J000.toString());
  print(obj.S000);
  print(obj.L000);
  print(obj.L000[0]);
  print(obj.J000[0].L000[0]);
  print(obj.R000);
  print(obj.E000.toStringValue());
  ////////////////////////////////////////
});
